...
dev.off()
tiff(paste0(rdsf_personal,"results/urate on gout forestplot.tiff"),width = 17, height = 2.5, res = 300, units = "in")
plot.new()
mtext("A)",side = 3,line = 2,adj = 0, cex = 1.5,padj = 0)
print(p1)
dev.off()
tiff(paste0(rdsf_personal,"results/sbp on stroke forestplot.tiff"),width = 17, height = 2.5, res = 300, units = "in")
plot.new()
print(p2)
mtext("B)",side = 3,line = 2,adj = 0,cex = 1.5,padj = 0)
dev.off()
tiff(paste0(rdsf_personal,"results/dbp on stroke forestplot.tiff"),width = 17, height = 2.5, res = 300, units = "in")
plot.new()
print(p3)
