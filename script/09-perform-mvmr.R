...
mvmr_exurate_sbp_egfr$result["exposure"][mvmr_exurate_sbp_egfr$result["exposure"] == "Urate"] <- "Urate (CKDGen)"
...
mvmr_exurate_dbp_egfr$result["exposure"][mvmr_exurate_dbp_egfr$result["exposure"] == "Urate"] <- "Urate (CKDGen)"
